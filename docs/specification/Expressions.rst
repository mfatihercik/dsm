...
Each complex tagType_ creates a node_. The created nodes can be accessed using the "all" object in the expressions. 
...
current node object that hold data of current complex tagType.
